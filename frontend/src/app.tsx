import { MapPin, Calendar, ArrowRight, UserRoundPlus, Settings2, X, AtSign, Plus, Users } from "lucide-react"
       ...
       <div className="flex flex-wrap gap-2">
        {emailsToInvite.map(email => {
          ...
          <button type="button" onClick={() => removeEmailFromInvites(email)}>
            <X className="siz-4 text-zinc-400" />
          </button>
          </div>
          )
        })}
    ...
    {isConfirmTripModalOpen && (
      ...
      <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
       ...
       <form onSubmit={addNewEmailToInvite} className="space-y-3">
        <div className="p-2.5 px-4 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2">
